...
| 31 | Knowledge, Research & Personal Intelligence OS (KROS) | [planners/knowledge-research-os/](./planners/knowledge-research-os/) | **Complete** (5 parts) |
...
| `NLB-KROS-*` | Knowledge, Research & Personal Intelligence OS — research methodology, verification, knowledge workspace, agentic pipelines, security, reasoning tools | [planners/knowledge-research-os/](./planners/knowledge-research-os/) | 001–005 (complete) |
