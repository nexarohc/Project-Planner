...
3. **Delegation moves work, never permission** — an agent that could acquire authority by asking another agent has no authority boundary, only an unenforced convention.
